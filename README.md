...
1. **Compose the Sanctuary**:
   Use the provided `docker-compose.yml` in the `docker/` directory:
...
2. **Verify Vital Signs**:
   The image includes a healthcheck. Monitor status with:
...
* **Contact**: [SorrowsCry86@gmail.org](mailto:SorrowsCry86@gmail.org)
